...
!function ($) {
    var DateRangePicker = function (element, options, cb) {
                ...
                '<div class="ranges">' +
                    '<div class="range_inputs">' +
                        '<div class="daterangepicker_start_input" style="float: left">' +
                            ...
                            '<input class="form-control" type="text" name="daterangepicker_start" value="" readonly="readonly" />' +
                        '</div>' +
                        '<div class="daterangepicker_end_input pb-3" style="float: left; padding-left: 11px">' +
                            '<label for="daterangepicker_end">' + this.locale.toLabel + '</label>' +
                            '<input class="form-control" type="text" name="daterangepicker_end" value="" readonly="readonly" />' +
                        '</div>' +
                        '<a href="javascript:;" class="'+ this.applyClass +' btn-primary btn btn-small applyBtn">'+ this.locale.applyLabel +'</a>&nbsp;' +
        ...
        this.container.find('.ranges')
            .on('click', 'a.applyBtn', $.proxy(this.clickApply, this))
    ...
    DateRangePicker.prototype = {
        ...
        updateInputText: function() {
            ...
            // customização by symee
            workDay(this.startDate.format(this.format), this.endDate.format(this.format));
        },
