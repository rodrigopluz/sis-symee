...
window.rangy = function() {
    ...
    function h() {
        if (!q.initialized) {
            ...
            b(document, "createRange") &&
                (a = document.createRange(), p(a, n) && t(a, m) && (d = !0), a.detach());
    ...
    var g = "object",
        j = "function",
        k = "undefined",
        m = "startContainer startOffset endContainer endOffset collapsed commonAncestorContainer START_TO_START START_TO_END END_TO_START END_TO_END".split(" "),
        n = "setStart setStartBefore setStartAfter setEnd setEndBefore setEndAfter collapse selectNode selectNodeContents compareBoundaryPoints deleteContents extractContents cloneContents insertNode surroundContents cloneRange toString detach".split(" "),
        v = "boundingHeight boundingLeft boundingTop boundingWidth htmlText text".split(" "),
    ...
    q.warn = function(a) {
        a = "Rangy warning: " + a;
        q.config.alertOnWarn ? window.alert(a) : typeof window.console != k && typeof window.console.log != k && window.console.log(a)
    };
    ({}).hasOwnProperty ? q.util.extend = function(a, b) {
        for (var c in b) b.hasOwnProperty(c) && (a[c] = b[c])
    } : f("hasOwnProperty not supported");
    var y = [],
        A = [];
    q.init = h;
    q.addInitListener = function(a) {
        q.initialized ? a(q) : y.push(a)
    };
    var B = [];
    q.addCreateMissingNativeApiListener = function(a) {
        B.push(a)
    };
    q.createMissingNativeApi = function(a) {
        a = a || window;
        h();
        for (var b = 0, c = B.length; b < c; ++b) B[b](a)
    };
    ...
    q.requireModules = function(a) {
        for (var b = 0, c = a.length, d, e; b <
            c; ++b) {
            e = a[b];
            d = q.modules[e];
            if (!d || !(d instanceof i)) throw Error("Module '" + e + "' not found");
            if (!d.supported) throw Error("Module '" + e + "' not supported");
        }
    };
    var D = !1,
        r = function() {
            D || (D = !0, q.initialized || h())
        };
    if (typeof window == k) f("No window found");
    else if (typeof document == k) f("No document found");
    else return b(document, "addEventListener") && document.addEventListener("DOMContentLoaded", r, !1), b(window, "addEventListener") ? window.addEventListener("load", r, !1) : b(window, "attachEvent") ? window.attachEvent("onload",
...
rangy.createModule("DomUtil", function(b, c) {
    ...
    b.dom = {
        ...
        getBody: function(a) {
            return v.isHostObject(a, "body") ? a.body : a.getElementsByTagName("body")[0]
        },
        ...
        comparePoints: function(b, c, g, j) {
            ...
            if (f = e(g, b, !0)) return c <= a(f) ? -1 : 1;
            if (f = e(b, g, !0)) return a(f) < j ? -1 : 1;
            c = d(b, g);
            b = b === c ? c : e(b, c, !0);
            g = g === c ? c : e(g, c, !0);
...
rangy.createModule("DomRange", function(b) {
    ...
    function d(a, b, c) {
        if (b = a._listeners[b])
            for (var d = 0, e = b.length; d < e; ++d) b[d].call(a, {
                target: a,
                args: c
            })
    }
    ...
    function e(a) {
        return new H(a.parentNode, l.getNodeIndex(a))
    }

    function f(a) {
        return new H(a.parentNode, l.getNodeIndex(a) + 1)
    }
    ...
    function i(b) {
        for (var c, d, e = a(b.range).createDocumentFragment(); d = b.next();) {
            c = b.isPartiallySelectedSubtree();
            d = d.cloneNode(!c);
            c && (c = b.getSubtreeIterator(), d.appendChild(i(c)), c.detach(!0));
            if (10 == d.nodeType) throw new C("HIERARCHY_REQUEST_ERR");
            e.appendChild(d)
        }
        return e
    }
    ...
    function k(b) {
        for (var c, d = a(b.range).createDocumentFragment(), e; c = b.next();) {
            b.isPartiallySelectedSubtree() ? (c = c.cloneNode(!1), e = b.getSubtreeIterator(), c.appendChild(k(e)), e.detach(!0)) : b.remove();
            if (10 == c.nodeType) throw new C("HIERARCHY_REQUEST_ERR");
            d.appendChild(c)
        }
        return d
    }
    ...
    function m(a, b, c) {
        ...
        d && (e = RegExp("^(" + b.join("|") + ")$"));
        var f = [];
        g(new v(a, !1), function(a) {
            (!d || e.test(a.nodeType)) && (!j || c(a)) && f.push(a)
        });
        return f
    }
    ...
    function r(a) {
        return function(b, c) {
            for (var d, e = c ? b : b.parentNode; e;) {
                d = e.nodeType;
                if (l.arrayContains(a, d)) return e;
                e = e.parentNode
            }
            return null
        }
    ...
    function t(a, b) {
        if (L(a, b)) throw new u("INVALID_NODE_TYPE_ERR");
    }

    function q(a) {
        if (!a.startContainer) throw new C("INVALID_STATE_ERR");
    }

    function y(a, b) {
        if (!l.arrayContains(b, a.nodeType)) throw new u("INVALID_NODE_TYPE_ERR");
    }

    function A(a, b) {
        if (0 > b || b > (l.isCharacterDataNode(a) ? a.length : a.childNodes.length)) throw new C("INDEX_SIZE_ERR");
    }

    function B(a, b) {
        if (I(a, !0) !== I(b, !0)) throw new C("WRONG_DOCUMENT_ERR");
    }

    function D(a) {
        if (T(a, !0)) throw new C("NO_MODIFICATION_ALLOWED_ERR");
    }
    ...
    function x(a) {
        q(a);
        if (!l.arrayContains(M, a.startContainer.nodeType) && !I(a.startContainer, !0) || !l.arrayContains(M, a.endContainer.nodeType) && !I(a.endContainer, !0) || !(a.startOffset <= (l.isCharacterDataNode(a.startContainer) ?
    ...
    function N(a, d, g) {
        ...
        function S(a, b, c) {
            ...
            if (b !== a.startContainer || c !== a.startOffset) {
                if (K(b) != K(e) || 1 == l.comparePoints(b, c, e, g)) e = b, g = c;
                d(a, b, c,
                    e, g)
            }
        }
        ...
        b.util.extend(a.prototype, {
            ...
            extractContents: J(k, d),
            deleteContents: J(j, d),
            ...
            splitBoundaries: function() {
                ...
                var a = this.startContainer,
                    ...
                    e = this.endOffset,
                    g = a === c;
                l.isCharacterDataNode(c) && (0 < e && e < c.length) && l.splitDataNode(c, e);
                l.isCharacterDataNode(a) && (0 < b && b < a.length) && (a = l.splitDataNode(a, b), g ? (e -= b, c = a) : c == a.parentNode && e >= l.getNodeIndex(a) && e++, b = 0);
                d(this, a, b, c, e)
            },
                ...
                var a = this.startContainer,
                    ...
                    j = function(d) {
                        ...
                        if (g && g.nodeType == d.nodeType) {
                            ...
                            a == c ? (e += b, c = a) : c == d.parentNode && (g = l.getNodeIndex(d), e == g ? (c = d, e = j) : e > g && e--)
                        }
                    },
                    f = !0;
                l.isCharacterDataNode(c) ? c.length == e && g(c) : (0 < e && (f = c.childNodes[e - 1]) && l.isCharacterDataNode(f) && g(f), f = !this.collapsed);
                f ? l.isCharacterDataNode(a) ? 0 == b && j(a) :
                    b < a.childNodes.length && (g = a.childNodes[b]) && l.isCharacterDataNode(g) && j(g) : (a = c, b = e);
                d(this, a, b, c, e)
            },
    ...
    function O(a, b, c, e, g) {
        var j = a.startContainer !==
            b || a.startOffset !== c,
            f = a.endContainer !== e || a.endOffset !== g;
        a.startContainer = b;
        a.startOffset = c;
        a.endContainer = e;
        a.endOffset = g;
    ...
    v.prototype = {
        ...
        getSubtreeIterator: function() {
            ...
            if (this.isSingleCharacterDataNode) b = this.range.cloneRange(), b.collapse();
                ...
                b = new w(a(this.range));
                var c = this._current,
                    d = c,
                    e = 0,
                    g = c,
                    j = l.getNodeLength(c);
                l.isAncestorOf(c, this.sc, !0) && (d = this.sc, e = this.so);
                l.isAncestorOf(c, this.ec, !0) && (g = this.ec, j = this.eo);
                O(b, d, e, g, j)
            }
            return new v(b, this.clonePartiallySelectedTextNodes)
        },
        detach: function(a) {
            a && this.range.detach();
    ...
    var X = "startContainer startOffset endContainer endOffset collapsed commonAncestorContainer".split(" "),
        U = 0,
        Y = 1,
        ca = 2,
        Z = 3,
    ...
    G.prototype = {
        ...
        insertNode: function(a) {
            ...
            y(a, F);
            D(this.startContainer);
            if (l.isAncestorOf(a, this.startContainer, !0)) throw new C("HIERARCHY_REQUEST_ERR");
            a = h(a, this.startContainer, this.startOffset);
        ...
        surroundContents: function(a) {
            y(a, P);
            if (!this.canSurroundContents()) throw new u("BAD_BOUNDARYPOINTS_ERR");
        ...
        cloneRange: function() {
            x(this);
            for (var b = new w(a(this)), c = X.length, d; c--;) d = X[c], b[d] = this[d];
            return b
        },
        toString: function() {
            x(this);
        ...
        compareNode: function(a) {
            ...
            var b = a.parentNode,
                c = l.getNodeIndex(a);
            if (!b) throw new C("NOT_FOUND_ERR");
            a = this.comparePoint(b, c);
            b = this.comparePoint(b, c + 1);
            return 0 > a ? 0 < b ? ba : $ : 0 < b ? aa : V
        },
        ...
        createContextualFragment: W ?
            function(a) {
                var b = this.startContainer,
                    c = l.getDocument(b);
                if (!b) throw new C("INVALID_STATE_ERR");
                var d = null;
        ...
        intersectsNode: function(b, c) {
            ...
            var d = b.parentNode,
                e = l.getNodeIndex(b);
            z(d, "NOT_FOUND_ERR");
            var g = l.comparePoints(d, e, this.endContainer, this.endOffset),
                d = l.comparePoints(d, e + 1, this.startContainer, this.startOffset);
            return c ? 0 >= g && 0 <= d : 0 > g && 0 < d
        },
        ...
        intersectsRange: function(b, c) {
            x(this);
            if (a(b) != a(this)) throw new C("WRONG_DOCUMENT_ERR");
            var d = l.comparePoints(this.startContainer, this.startOffset, b.endContainer, b.endOffset),
                e = l.comparePoints(this.endContainer, this.endOffset, b.startContainer, b.startOffset);
            return c ? 0 >= d && 0 <= e : 0 > d && 0 < e
        },
        ...
        containsNode: function(a, b) {
            return b ? this.intersectsNode(a, !1) : this.compareNode(a) == V
        },
...
rangy.createModule("WrappedRange", function(b) {
    function c(a, b, c, d) {
        ...
        e.isAncestorOf(b, j, !0) || (j = b);
        if (!j.canHaveHTML) return new f(j.parentNode, e.getNodeIndex(j));
        var b = e.getDocument(j).createElement("span"),
            h, k = c ? "StartToStart" : "StartToEnd";
        do j.insertBefore(b, b.previousSibling), g.moveToElementText(b); while (0 < (h = g.compareEndPoints(k, a)) && b.previousSibling);
        k = b.nextSibling;
        if (-1 == h && k && e.isCharacterDataNode(k)) {
            g.setEndPoint(c ? "EndToStart" : "EndToEnd",
                a);
            if (/[\r\n]/.test(k.data)) {
                j = g.duplicate();
                c = j.text.replace(/\r\n/g, "\r").length;
                for (c = j.moveStart("character", c); - 1 == j.compareEndPoints("StartToEnd", j);) c++, j.moveStart("character", 1)
            } else c = g.text.length;
            j = new f(k, c)
        } else k = (d || !c) && b.previousSibling, j = (c = (d || c) && b.nextSibling) && e.isCharacterDataNode(c) ? new f(c, 0) : k && e.isCharacterDataNode(k) ? new f(k, k.length) : new f(j, e.getNodeIndex(b));
    ...
    function a(a, b) {
        var c, d, g = a.offset,
            ...
            f = j.body.createTextRange(),
            h = e.isCharacterDataNode(a.node);
        h ? (c = a.node, d = c.parentNode) : (c = a.node.childNodes, c = g < c.length ? c[g] : null, d = a.node);
        j = j.createElement("span");
        j.innerHTML = "&#feff;";
        c ? d.insertBefore(j, c) : d.appendChild(j);
        f.moveToElementText(j);
        f.collapse(!b);
        d.removeChild(j);
        if (h) f[b ? "moveStart" : "moveEnd"]("character", g);
        return f
    }
    ...
    if (b.features.implementsDomRange && (!b.features.implementsTextRange || !b.config.preferTextRange)) {
        var i = function(a) {
                for (var b =
                        j.length, c; b--;) c = j[b], a[c] = a.nativeRange[c]
            },
            g, j = h.rangeProperties,
            k;
        d = function(a) {
        ...
        h.createPrototypeRange(d, function(a, b, c, d, e) {
            var g = a.endContainer !== d || a.endOffset != e;
            if (a.startContainer !== b || a.startOffset != c || g) a.setEnd(d, e), a.setStart(b, c)
        }, function(a) {
        ...
        n.setEnd(m, 0);
        try {
            n.setStart(m, 1), g.setStart = function(a, b) {
        ...
        g.selectNodeContents = n.startContainer ==
            m && n.endContainer == m && 0 == n.startOffset && n.endOffset == m.length ? function(a) {
        ...
        k.setEnd(m, 4);
        k.setStart(m, 2);
        g.compareBoundaryPoints = -1 == n.compareBoundaryPoints(n.START_TO_END, k) & 1 == n.compareBoundaryPoints(n.END_TO_START, k) ? function(a, b) {
            b = b.nativeRange || b;
        ...
        b.util.isHostMethod(n, "createContextualFragment") && (g.createContextualFragment = function(a) {
    ...
    } else b.features.implementsTextRange && (d = function(a) {
            this.textRange = a;
            this.refresh()
        },
        ...
        g = function() {
            return this
        }(), "undefined" == typeof g.Range && (g.Range = d), b.createNativeRange = function(a) {
            a = a || document;
    ...
    b.addCreateMissingNativeApiListener(function(a) {
        a = a.document;
        "undefined" == typeof a.createRange && (a.createRange = function() {
...
rangy.createModule("WrappedSelection", function(b, c) {
    ...
    function h(a) {
        var c;
        a instanceof t ? (c = a._selectionNativeRange,
            c || (c = b.createNativeRange(p.getDocument(a.startContainer)), c.setEnd(a.endContainer, a.endOffset), c.setStart(a.startContainer, a.startOffset), a._selectionNativeRange = c, a.attachListener("detach", function() {
                this._selectionNativeRange = null
            }))) : a instanceof q ? c = a.nativeRange : b.features.implementsDomRange && a instanceof p.getWindow(a.startContainer).Range && (c = a);
        return c
    }
    ...
    function j(a) {
        ...
        if ("None" == a.docSelection.type) f(a);
            ...
            if (c && "undefined" != typeof c.text) g(a, c);
            else {
                a.rangeCount = c.length;
                for (var d, j = p.getDocument(c.item(0)), h = 0; h < a.rangeCount; ++h) d = b.createRange(j), d.selectNode(c.item(h)),
                    a._ranges.push(d);
    ...
    function k(a, b) {
        for (var c = a.docSelection.createRange(), d = i(b), e = p.getDocument(c.item(0)), e = p.getBody(e).createControlRange(), g = 0, f = c.length; g < f; ++g) e.add(c.item(g));
        try {
            e.add(d)
        } catch (h) {
    ...
    function n(a, b) {
        for (var c = p.getDocument(b[0].startContainer), c = p.getBody(c).createControlRange(), d = 0, e; d < rangeCount; ++d) {
            e = i(b[d]);
            try {
                c.add(e)
            } catch (g) {
    ...
    function v(a, b) {
        if (a.anchorNode && p.getDocument(a.anchorNode) !== p.getDocument(b)) throw new y("WRONG_DOCUMENT_ERR");
    }

    function u(a) {
        var b = [],
            c = new A(a.anchorNode, a.anchorOffset),
            d = new A(a.focusNode, a.focusOffset),
            e = "function" == typeof a.getName ? a.getName() : "Selection";
        if ("undefined" != typeof a.rangeCount)
            for (var g = 0, j = a.rangeCount; g < j; ++g) b[g] = t.inspect(a.getRangeAt(g));
    ...
    var p = b.dom,
        ...
        y = b.DOMException,
        A = p.DomPosition,
        B, D, z = b.util.isHostMethod(window, "getSelection"),
        x = b.util.isHostObject(document, "selection"),
        G = x && (!z || b.config.preferTextRange);
    G ? (B = d, b.isSelectionValid = function(a) {
    ...
    var z = B(),
        Q = b.createNativeRange(document),
        s = p.getBody(document),
        J = r.areHostObjects(z, r.areHostProperties(z, ["anchorOffset", "focusOffset"]));
    ...
    if (r.areHostMethods(z, ["addRange", "getRangeAt", "removeAllRanges"]) && "number" == typeof z.rangeCount && b.features.implementsDomRange) {
        ...
        w.close();
        var H = p.getIframeWindow(l).getSelection(),
            C = w.documentElement.lastChild.firstChild,
            E = w.createRange();
        E.setStart(C, 1);
        E.collapse(!0);
        H.addRange(E);
    ...
    var F = !1;
    s && r.isHostMethod(s, "createControlRange") && (s = s.createControlRange(), r.areHostProperties(s, ["item", "add"]) && (F = !0));
    ...
    var P;
    r.isHostMethod(z, "getRangeAt") ? P = function(a, b) {
        try {
        ...
        var c = p.getDocument(a.anchorNode),
            c = b.createRange(c);
        c.setStart(a.anchorNode, a.anchorOffset);
        c.setEnd(a.focusNode, a.focusOffset);
        c.collapsed !== this.isCollapsed && (c.setStart(a.focusNode, a.focusOffset),
    ...
    b.getSelection = function(a) {
        var a = a || window,
            ...
            c = B(a),
            e = x ? d(a) : null;
        b ? (b.nativeSelection = c, b.docSelection = e, b.refresh(a)) : (b = new m(c, e, a), a._rangySelection = b);
        return b
    };
    b.getIframeSelection = function(a) {
        return b.getSelection(p.getIframeWindow(a))
    };
    s = m.prototype;
    if (!G && J && r.areHostMethods(z, ["removeAllRanges", "addRange"])) {
        ...
        s.addRange = R ? function(a, c) {
            if (F && x && "Control" == this.docSelection.type) k(this, a);
            else if (c && N) K(this, a);
            else {
                var d;
                O ? d = this.rangeCount : (this.removeAllRanges(), d = 0);
                this.nativeSelection.addRange(h(a));
                this.rangeCount = this.nativeSelection.rangeCount;
                this.rangeCount == d + 1 ? (b.config.checkSelectionRanges && (d = P(this.nativeSelection, this.rangeCount -
                    1)) && !t.rangesEqual(d, a) && (a = new q(d)), this._ranges[this.rangeCount - 1] = a, e(this, a, L(this.nativeSelection)), this.isCollapsed = D(this)) : this.refresh()
            }
        } : function(a, b) {
            b && N ? K(this, a) : (this.nativeSelection.addRange(h(a)), this.refresh())
        };
        s.setRanges = function(a) {
            if (F && 1 < a.length) n(this, a);
            else {
                this.removeAllRanges();
                for (var b = 0, c = a.length; b < c; ++b) this.addRange(a[b])
            }
        }
    } else if (r.isHostMethod(z, "empty") && r.isHostMethod(Q, "select") && F && G) s.removeAllRanges = function() {
            try {
                if (this.docSelection.empty(), "None" !=
                    this.docSelection.type) {
                    var a;
                    if (this.anchorNode) a = p.getDocument(this.anchorNode);
            ...
            "Control" == this.docSelection.type ? k(this, a) : (q.rangeToTextRange(a).select(), this._ranges[0] = a, this.rangeCount = 1, this.isCollapsed = this._ranges[0].collapsed, e(this, a, !1))
        },
        s.setRanges = function(a) {
            this.removeAllRanges();
            var b = a.length;
            1 < b ? n(this, a) : b && this.addRange(a[0])
        };
    else return c.fail("No means of selecting a Range or TextRange was found"), !1;
    s.getRangeAt = function(a) {
        if (0 > a || a >= this.rangeCount) throw new y("INDEX_SIZE_ERR");
        return this._ranges[a]
    };
    var I;
    if (G) I = function(a) {
        var c;
        b.isSelectionValid(a.win) ? c = a.docSelection.createRange() : (c = p.getBody(a.win.document).createTextRange(), c.collapse(!0));
        "Control" == a.docSelection.type ? j(a) : c && "undefined" != typeof c.text ?
            g(a, c) : f(a)
    };
    else if (r.isHostMethod(z, "getRangeAt") && "number" == typeof z.rangeCount) I = function(a) {
        if (F && x && "Control" == a.docSelection.type) j(a);
            ...
            e(a, a._ranges[a.rangeCount - 1], L(a.nativeSelection));
            a.isCollapsed = D(a)
        } else f(a)
    };
    else if (J && "boolean" == typeof z.isCollapsed && "boolean" == typeof Q.collapsed && b.features.implementsDomRange) I =
        function(a) {
            var b;
            b = a.nativeSelection;
            b.anchorNode ? (b = P(b, 0), a._ranges = [b], a.rangeCount = 1, b = a.nativeSelection, a.anchorNode = b.anchorNode, a.anchorOffset = b.anchorOffset, a.focusNode = b.focusNode, a.focusOffset = b.focusOffset, a.isCollapsed = D(a)) : f(a)
        };
    ...
    var T = function(a, b) {
        var c = a.getAllRanges(),
            d = !1;
        a.removeAllRanges();
        for (var e = 0, g = c.length; e < g; ++e) d || b !== c[e] ? a.addRange(c[e]) : d = !0;
        a.rangeCount || f(a)
    };
    s.removeRange = F ? function(a) {
        if ("Control" == this.docSelection.type) {
            for (var b = this.docSelection.createRange(), a = i(a), c = p.getDocument(b.item(0)), c = p.getBody(c).createControlRange(), d, e = !1, g = 0, f = b.length; g < f; ++g) d = b.item(g), d !== a || e ? c.add(b.item(g)) : e = !0;
            c.select();
            j(this)
        } else T(this, a)
    } : function(a) {
    ...
    var L;
    !G && J && b.features.implementsDomRange ?
        (L = function(a) {
            var b = !1;
    ...
    s.collapse = function(a, c) {
        v(this, a);
        var d = b.createRange(p.getDocument(a));
        d.collapseToPoint(a, c);
        this.removeAllRanges();
        this.addRange(d);
        this.isCollapsed = !0
    };
    s.collapseToStart = function() {
        ...
        } else throw new y("INVALID_STATE_ERR");
    };
    ...
    s.selectAllChildren = function(a) {
        v(this, a);
        var c = b.createRange(p.getDocument(a));
    ...
    s.toHtml = function() {
        ...
        if (this.rangeCount) {
            for (var a =
                    t.getRangeDocument(this._ranges[0]).createElement("div"), b = 0, c = this._ranges.length; b < c; ++b) a.appendChild(this._ranges[b].cloneContents());
            a = a.innerHTML
        }
        return a
    };
...
wysihtml5.browser = function() {
    var b = navigator.userAgent,
        ...
        i = {
            formatBlock: a,
            insertUnorderedList: a || e,
            insertOrderedList: a || e
        },
        g = {
            insertHTML: d
        };
    return {
        ...
        supported: function() {
            var a = this.USER_AGENT.toLowerCase(),
                ...
                d = document.execCommand && document.queryCommandSupported &&
                document.queryCommandState,
                e = document.querySelector && document.querySelectorAll,
                a = this.isIos() && 5 > +(/ipad|iphone|ipod/.test(a) && a.match(/ os (\d+).+? like mac os x/) || [, 0])[1] || this.isAndroid() && 4 > +(a.match(/android (\d+)/) || [, 0])[1] || -1 !== a.indexOf("opera mobi") || -1 !== a.indexOf("hpwos/");
            return b && d && e && !a
        },
        ...
        supportsEvent: function(a) {
            var b;
            if (!(b = "on" + a in c)) c.setAttribute("on" + a, "return;"),
                b = "function" === typeof c["on" + a];
            return b
        },
        ...
        supportsCommand: function(a, b) {
            if (!i[b]) {
                try {
                    return a.queryCommandSupported(b)
                } catch (c) {}
                try {
...
wysihtml5.lang.Dispatcher = Base.extend({
    ...
    off: function(b, c) {
        ...
        if (b) {
            d = this.events[b] || [];
            for (e = []; a < d.length; a++) d[a] !== c && c && e.push(d[a]);
            this.events[b] = e
        } else this.events = {};
        return this
    },
...
(function(b) {
    function c(i) {
        if (!a.contains(i.nodeName))
            if (i.nodeType === b.TEXT_NODE && i.data.match(d)) {
                ...
                j = k;
                j.innerHTML = "<span></span>" + i.data.replace(d, function(a, b) {
                    var c = (b.match(e) || [])[1] || "",
                        d = h[c],
                        b = b.replace(e, "");
                    b.split(d).length > b.split(c).length && (b += c, c = "");
                    var g = d = b;
                    b.length > f && (g = g.substr(0, f) + "...");
                    "www." === d.substr(0, 4) && (d = "http://" + d);
                    return '<a href="' + d + '">' +
                        g + "</a>" + c
                });
                for (j.removeChild(j.firstChild); j.firstChild;) g.insertBefore(j.firstChild, i);
                g.removeChild(i)
            } else {
    ...
    var a = b.lang.array("CODE PRE A SCRIPT HEAD TITLE STYLE".split(" ")),
        d = /((https?:\/\/|www\.)[^\s<]{3,})/gi,
        e = /([^\w\/\-](,?))$/i,
        f = 100,
        h = {
...
wysihtml5.dom.convertToList = function() {
    ...
    return function(c, a) {
        ...
        for (m = 0; m < h; m++)
            for (i = f[m];
                (g = i.parentNode) && g !== c && g.lastChild === i;) {
        ...
        h = f.length;
        for (m = 0; m < h; m++) k = k || b(d, e), i = f[m], g = "block" === wysihtml5.dom.getStyle("display").from(i), j = "BR" === i.nodeName, g ? (k = k.firstChild ? b(d, e) : k, k.appendChild(i), k = null) : j ? k = k.firstChild ? null : k : k.appendChild(i);
        0 === f.length && b(d, e);
    ...
    b.copyStyles = function(a) {
        return {
            from: function(d) {
                ...
                e = e ? parseInt(b.getStyle("width").from(d), 10) < d.offsetWidth : !1;
                e && (a = wysihtml5.lang.array(a).without(c));
                var h = "";
                e = a.length;
                for (var f = 0, i; f < e; f++) i = a[f], h += i + ":" + b.getStyle(i).from(d) + ";";
                return {
                    to: function(a) {
                        b.setStyles(h).on(a);
                        return {
            ...
            from: function(d) {
                if (d.nodeType === wysihtml5.ELEMENT_NODE) {
                    ...
                    var f = e.defaultView || e.parentWindow,
                        ...
                        k;
                    if (f.getComputedStyle) return e &&
                        (k = h.overflow, h.overflow = "hidden"), d = f.getComputedStyle(d, null).getPropertyValue(a), e && (h.overflow = k || ""), d
                }
            }
        }
    }
...
wysihtml5.dom.observe = function(b, c, a) {
    ...
    return {
        stop: function() {
            for (var e, g = 0, f = c.length; g < f; g++) e = c[g], b.removeEventListener ? b.removeEventListener(e, a, !1) : b.detachEvent("on" +
                e, d)
        }
    }
};
wysihtml5.dom.parse = function() {
    function b(c, e) {
        var g = c.childNodes,
            ...
            k, j = j && j(c);
        if (!j) return null;
        for (h = 0; h < f; h++)(k = b(g[h], e)) && j.appendChild(k);
        return e && 1 >= j.childNodes.length && j.nodeName.toLowerCase() === d && !j.attributes.length ? j.firstChild : j
    }
    ...
    function c(a, b) {
        ...
        return c ? a.src : i && "outerHTML" in a ? -1 != a.outerHTML.toLowerCase().indexOf(" " + b + "=") ? a.getAttribute(b) : null : a.getAttribute(b)
    }
    var a = {
            1: function(a) {
                var b, g, j = h.tags;
                ...
                b && "HTML" != b && (g = b + ":" + g);
                "outerHTML" in a && !wysihtml5.browser.autoClosesUnclosedTags() && ("P" === a.nodeName && "</p>" !== a.outerHTML.slice(-4).toLowerCase()) && (g = "div");
                if (g in j) {
                    b = j[g];
                ...
                g = a.ownerDocument.createElement(b.rename_tag || g);
                var j = {},
                    f = b.set_class,
                    k = b.add_class,
                    i = b.set_attributes,
                    m = b.check_attributes,
                    n = h.classes,
                    p = 0,
                    t = [];
                b = [];
                var u = [],
                    r = [],
                    w;
                i && (j = wysihtml5.lang.object(i).clone());
                if (m)
                    for (w in m)
                        if (i = v[m[w]]) i = i(c(a, w)), "string" === typeof i && (j[w] = i);
                f && t.push(f);
                if (k)
                    for (w in k)
                        if (i = q[k[w]]) f = i(c(a, w)), "string" === typeof f && t.push(f);
                n["_wysihtml5-temp-placeholder"] = 1;
                (r = a.getAttribute("class")) &&
                (t = t.concat(r.split(e)));
                for (k = t.length; p < k; p++) a = t[p], n[a] && b.push(a);
                for (n = b.length; n--;) a = b[n], wysihtml5.lang.array(u).contains(a) || u.unshift(a);
                u.length && (j["class"] = u.join(" "));
                for (w in j) try {
                    g.setAttribute(w, j[w])
                } catch (l) {}
                j.src && ("undefined" !== typeof j.width && g.setAttribute("width", j.width), "undefined" !== typeof j.height && g.setAttribute("height", j.height));
                return g
            },
            3: function(a) {
        ...
        v = {
            url: function(a) {
                return !a || !a.match(g) ? null : a.replace(g, function(a) {
                    return a.toLowerCase()
                })
            },
            src: function(a) {
                return !a || !a.match(j) ? null : a.replace(j, function(a) {
                    return a.toLowerCase()
                })
            },
            href: function(a) {
                return !a || !a.match(k) ? null : a.replace(k, function(a) {
                    return a.toLowerCase()
                })
            },
            alt: function(a) {
        ...
        q = {
            align_img: function(a) {
                return u[String(a).toLowerCase()]
            },
            align_text: function(a) {
                return p[String(a).toLowerCase()]
            },
            clear_br: function(a) {
                return r[String(a).toLowerCase()]
            },
            size_font: function(a) {
                return t[String(a).charAt(0)]
            }
        };
    return function(a, c, d, e) {
        ...
        a.innerHTML = "";
        a.appendChild(c);
        return g ? wysihtml5.quirks.getCorrectInnerHTML(a) : a
    }
}();
    ...
    b.resolveList = function(a, d) {
        if (a.nodeName.match(/^(MENU|UL|OL)$/)) {
            var e = a.ownerDocument,
                ...
                h = a.previousElementSibling || a.previousSibling,
                i, g;
            if (d)
                for (h && "block" !== b.getStyle("display").from(h) && c(f); g = a.firstElementChild || a.firstChild;) {
                    for (e = g.lastChild; h = g.firstChild;) i = (i = h === e) && "block" !== b.getStyle("display").from(h) && "BR" !== h.nodeName, f.appendChild(h), i && c(f);
                    g.parentNode.removeChild(g)
                } else
                    for (; g =
                        a.firstElementChild || a.firstChild;) {
                        if (g.querySelector && g.querySelector("div, p, ul, ol, menu, blockquote, h1, h2, h3, h4, h5, h6"))
                            for (; h = g.firstChild;) f.appendChild(h);
                        else {
                            for (i = e.createElement("p"); h = g.firstChild;) i.appendChild(h);
                            f.appendChild(i)
                        }
                        g.parentNode.removeChild(g)
                    }
    ...
    b.dom.Sandbox = Base.extend({
        ...
        _createIframe: function() {
            ...
            d.onreadystatechange = function() {
                /loaded|complete/.test(d.readyState) && (d.onreadystatechange = d.onload = null, a._onLoadIframe(d))
            };
            return d
        },
        _onLoadIframe: function(f) {
            if (b.dom.contains(c.documentElement, f)) {
                ...
                if (!b.browser.supportsSandboxedIframes()) {
                    var k, j = 0;
                    for (k = a.length; j < k; j++) this._unset(i, a[j]);
                    j = 0;
                    for (k = d.length; j < k; j++) this._unset(i, d[j], b.EMPTY_FUNCTION);
                    j = 0;
                    for (k = e.length; j < k; j++) this._unset(g, e[j]);
                    this._unset(g,
                        "cookie", "", !0)
                }
                this.loaded = !0;
        ...
        _getHtml: function(a) {
            ...
            if (c = "string" === typeof c ? [c] : c)
                for (j = c.length; e < j; e++) d += '<link rel="stylesheet" href="' + c[e] + '">';
            a.stylesheets = d;
...
(function(b) {
    b.simulatePlaceholder = function(c, a, d) {
        var e = function() {
            ...
            f = function() {
                a.isEmpty() && (a.placeholderSet = !0, a.setValue(d), b.addClass(a.element, "placeholder"))
            };
...
wysihtml5.quirks.ensureProperClearing = function() {
    var b = function() {
        ...
        setTimeout(function() {
            ...
            if ("<p>&nbsp;</p>" == a || "<p>&nbsp;</p><p>&nbsp;</p>" == a) b.innerHTML = ""
        }, 0)
    };
    return function(c) {
    ...
    b.Selection = Base.extend({
        ...
        selectNode: function(a, d) {
            var e = rangy.createRange(this.doc),
                f = a.nodeType === b.ELEMENT_NODE,
                h = "canHaveHTML" in a ? a.canHaveHTML : "IMG" !== a.nodeName,
                i = f ? a.innerHTML : a.data,
                i = "" === i || i === b.INVISIBLE_SPACE,
                g = c.getStyle("display").from(a),
                g = "block" === g || "list-item" === g;
            if (i && f && h && !d) try {
        ...
        getSelectedNode: function(a) {
            if (a && this.doc.selection &&
                "Control" === this.doc.selection.type && (a = this.doc.selection.createRange()) && a.length) return a.item(0);
        ...
        executeAndRestore: function(a, d) {
            var e = this.doc.body,
                ...
                g = this.getRange(this.doc),
                j;
            if (g) {
                b.browser.hasInsertNodeIssue() ? this.doc.execCommand("insertHTML", !1, i) : (i = g.createContextualFragment(i), g.insertNode(i));
                try {
        ...
        executeAndRestoreSimple: function(a) {
            ...
            if (f) {
                ...
                b = h === f.startContainer ? f.startOffset : 0;
        ...
        scrollIntoView: function() {
            ...
            if (c) {
                ...
                c >= a.body.scrollTop + a.documentElement.offsetHeight - 5 && (a.body.scrollTop = c)
            }
        },
        selectLine: function() {
        ...
        _selectLine_MSIE: function() {
            var a = this.doc.selection.createRange(),
                ...
                f;
            if (a.moveToPoint) {
                0 === b && (f = this.doc.createElement("span"), this.insertNode(f), b = f.offsetTop, f.parentNode.removeChild(f));
                b += 1;
...
(function(b, c) {
    ...
    f.prototype = {
        ...
        postApply: function(a, b) {
            for (var c = a[0], d = a[a.length - 1], f = [], h, i = c, p = d, r = 0, t = d.length, q, y, A = 0, B = a.length; A < B; ++A) q = a[A], (y = this.getAdjacentMergeableTextNode(q.parentNode, !1)) ? (h || (h = new e(y), f.push(h)), h.textNodes.push(q), q === c && (i = h.firstTextNode, r = i.length), q === d && (p = h.firstTextNode, t = h.getLength())) : h = null;
        ...
        areElementsMergeable: function(a, b) {
            ...
            if (d = c.dom.arrayContains(this.tagNames, (a.tagName || "").toLowerCase()))
                if (d = c.dom.arrayContains(this.tagNames, (b.tagName || "").toLowerCase()))
                    if (d =
                        a.className.replace(i, " ") == b.className.replace(i, " ")) a: if (a.attributes.length != b.attributes.length) d = !1;
                        else {
                            d = 0;
        ...
        applyToTextNode: function(a) {
            ...
            1 == b.childNodes.length &&
                c.dom.arrayContains(this.tagNames, b.tagName.toLowerCase()) ? this.cssClass && (a = this.cssClass, b.className ? (b.className && (b.className = b.className.replace(this.similarClassRegExp, "")), b.className += " " + a) : b.className = a) : (b = this.createContainer(c.dom.getDocument(a)), a.parentNode.insertBefore(b, a), b.appendChild(a))
        },
        ...
        undoToTextNode: function(b, c, e) {
            c.containsNode(e) ||
                (b = c.cloneRange(), b.selectNode(e), b.isPointInRange(c.endContainer, c.endOffset) && a(c.endContainer, c.endOffset) && (d(e, c.endContainer, c.endOffset), c.setEndAfter(e)), b.isPointInRange(c.startContainer, c.startOffset) && a(c.startContainer, c.startOffset) && (e = d(e, c.startContainer, c.startOffset)));
            this.similarClassRegExp && e.className && (e.className = e.className.replace(this.similarClassRegExp, ""));
            if (this.isRemovable(e)) {
                c = e;
                for (e = c.parentNode; c.firstChild;) e.insertBefore(c.firstChild, c);
                e.removeChild(c)
            }
        },
        applyToRange: function(a) {
            var c =
                a.getNodes([b.TEXT_NODE]);
            if (!c.length) try {
        ...
        undoToRange: function(a) {
            var c = a.getNodes([b.TEXT_NODE]),
                d, e;
            c.length ? (a.splitBoundaries(), c = a.getNodes([b.TEXT_NODE])) :
                (c = a.endContainer.ownerDocument.createTextNode(b.INVISIBLE_SPACE), a.insertNode(c), a.selectNode(c), c = [c]);
        ...
        isAppliedToRange: function(a) {
            ...
            for (var f = 0, h = e.length, i; f < h; ++f) {
                i = this.getTextSelectedByRange(e[f], a);
...
(function(b) {
    ...
    b.commands.createLink = {
        exec: function(a, d, e) {
            ...
            if (f) a.selection.executeAndRestore(function() {
                for (var a = f.length, b = 0, d, e, g; b < a; b++) d = f[b], e = c.getParentElement(d, {
                    nodeName: "code"
                }), g = c.getTextContent(d), g.match(c.autoLink.URL_REG_EXP) && !e ? c.renameElement(d, "code") : c.replaceWithChildNodes(d)
            });
            else {
                var d = e = "object" === typeof e ? e : {
                        href: e
                    },
                    e = a.doc,
                ...
                for (h = g.length; i < h; i++)
                    for (k in j = g[i], j.removeAttribute("class"), d) j.setAttribute(k, d[k]);
                k = j;
...
(function(b) {
    ...
    function d(a) {
        return "BR" === a.nodeName || "block" === e.getStyle("display").from(a) ? !0 : !1
    }
    var e = b.dom,
        f = "H1 H2 H3 H4 H5 H6 P BLOCKQUOTE DIV".split(" ");
    b.commands.formatBlock = {
        exec: function(h, i, g, j, k) {
            var m = h.doc,
                n = this.state(h, i, g, j, k),
                v = h.config.useLineBreaks,
                u = v ? "DIV" : "P",
                p, g = "string" === typeof g ? g.toUpperCase() : g;
            if (n) h.selection.executeAndRestoreSimple(function() {
                ...
                if (!b.lang.string(n.className).trim() && (v || "P" === g)) {
                    var f = n,
                        ...
                        j = a(f),
                        i = c(f);
                    j && !d(j) && f.parentNode.insertBefore(h.createElement("br"), j);
                    i && !d(i) && f.parentNode.insertBefore(h.createElement("br"), f);
                    e.replaceWithChildNodes(n)
                } else e.renameElement(n, "P" === g ? "DIV" : u)
            });
            else {
                if (null === g || b.lang.array(f).contains(g))
                    if (p = h.selection.getSelectedNode(),
                        n = e.getParentElement(p, {
                            nodeName: f
                        })) {
                        h.selection.executeAndRestore(function() {
                            ...
                            if (j) {
                                var a = n;
                                a.className ? (a.className = a.className.replace(k, ""), a.className += " " + j) : a.className = j
                            }
                        });
                        return
                    }
                if (h.commands.support(i)) {
                    h = g || u;
                    if (j) var r = e.observe(m, "DOMNodeInserted", function(a) {
                        var a = a.target,
                            c;
                        a.nodeType === b.ELEMENT_NODE && (c = e.getStyle("display").from(a), "inline" !== c.substr(0, 6) && (a.className += " " + j))
                    });
                    m.execCommand(i, !1, h);
                    r && r.stop()
                } else n = m.createElement(g || u), j && (n.className =
                    j), i = n, h.selection.selectLine(), h.selection.surround(i), m = a(i), r = c(i), m && "BR" === m.nodeName && m.parentNode.removeChild(m), r && "BR" === r.nodeName && r.parentNode.removeChild(r), (m = i.lastChild) && "BR" === m.nodeName && m.parentNode.removeChild(m), h.selection.selectNode(i, b.browser.displaysCaretInEmptyContentEditableCorrectly())
            }
        },
        state: function(a, b, c, d, f) {
            c = "string" === typeof c ? c.toUpperCase() : c;
            a = a.selection.getSelectedNode();
            return e.getParentElement(a, {
                nodeName: c,
                className: d,
                classRegExp: f
            })
...
(function(b) {
    function c(c, f, h) {
        ...
        if (!d[i]) {
            var g = d,
                j = b.selection.HTMLApplier,
                k = a[c],
                c = k ? [c.toLowerCase(), k.toLowerCase()] : [c.toLowerCase()];
            g[i] = new j(c, f, h, !0)
        }
        return d[i]
    }
    ...
    b.commands.formatInline = {
        ...
        state: function(d, f, h, i, g) {
            var f = d.doc,
                j = a[h] || h;
            if (!b.dom.hasElementWithTagName(f, h) && !b.dom.hasElementWithTagName(f, j) || i &&
...
wysihtml5.commands.insertHTML = {
    exec: function(b, c, a) {
        b.commands.support(c) ? b.doc.execCommand(c, !1, a) : b.selection.insertHTML(a)
    },
    state: function() {
        return !1
    }
    ...
    b.commands.insertImage = {
        exec: function(c, a, d) {
            ...
            if (a) c.selection.setBefore(a), d = a.parentNode, d.removeChild(a), b.dom.removeEmptyTextNodes(d), "A" === d.nodeName && !d.firstChild && (c.selection.setAfter(d), d.parentNode.removeChild(d)), b.quirks.redraw(c.element);
                ...
                for (f in d) "className" === f && (f = "class"), a.setAttribute(f, d[f]);
                c.selection.insertNode(a);
                b.browser.hasProblemsSettingCaretAfterImg() ? (d = e.createTextNode(b.INVISIBLE_SPACE),
                    c.selection.insertNode(d), c.selection.setAfter(d)) : c.selection.setAfter(a)
            }
        },
        state: function(c) {
            var a;
...
wysihtml5.commands.insertOrderedList = {
    exec: function(b, c) {
        var a = b.doc,
            d = b.selection.getSelectedNode(),
            e = wysihtml5.dom.getParentElement(d, {
                nodeName: "OL"
            }),
            f = wysihtml5.dom.getParentElement(d, {
                nodeName: "UL"
            }),
            d = "_wysihtml5-temp-" + (new Date).getTime(),
            h;
        !e && !f && b.commands.support(c) ? a.execCommand(c, !1, null) : e ? b.selection.executeAndRestore(function() {
            ...
            "div", d), h = a.querySelector("." + d), a = "" === h.innerHTML || h.innerHTML === wysihtml5.INVISIBLE_SPACE || "<br>" === h.innerHTML, b.selection.executeAndRestore(function() {
            e = wysihtml5.dom.convertToList(h, "ol")
        }), a && b.selection.selectNode(e.querySelector("li"), !0))
    },
    state: function(b) {
        b = b.selection.getSelectedNode();
        return wysihtml5.dom.getParentElement(b, {
            nodeName: "OL"
        })
    }
};
...
(function(b) {
    ...
    b.UndoManager = b.lang.Dispatcher.extend({
            ...
            if (b.browser.hasUndoInContextMenu()) {
                ...
                d.observe(this.element, "contextmenu", function() {
                    ...
                    e.composer.selection.executeAndRestoreSimple(function() {
                        e.element.lastChild &&
                            e.composer.selection.setAfter(e.element.lastChild);
                    ...
                    g || (g = !0, d.observe(document, "mousedown", j), d.observe(f, ["mousedown", "paste", "cut", "copy"], j))
                })
            }
        ...
        transact: function() {
            var a =
                this.historyStr[this.position - 1],
                c = this.composer.getValue();
            if (c !== a) {
                if (25 < (this.historyStr.length = this.historyDom.length = this.position)) this.historyStr.shift(), this.historyDom.shift(), this.position--;
                this.position++;
                var d = this.composer.selection.getRange(),
                    a = d.startContainer || this.element,
                    i = d.startOffset || 0,
                    g;
                a.nodeType === b.ELEMENT_NODE ? d = a : (d = a.parentNode, g = this.getChildNodeIndex(d, a));
                d.setAttribute("data-wysihtml5-selection-offset", i);
                "undefined" !== typeof g && d.setAttribute("data-wysihtml5-selection-node",
                    g);
                g = this.element.cloneNode(!!c);
                this.historyDom.push(g);
                this.historyStr.push(c);
                d.removeAttribute("data-wysihtml5-selection-offset");
                d.removeAttribute("data-wysihtml5-selection-node")
            }
        },
        undo: function() {
            this.transact();
        ...
        set: function(a) {
            ...
            for (var b = 0, c = a.childNodes, d = a.childNodes.length; b < d; b++) this.element.appendChild(c[b].cloneNode(!0));
            a.hasAttribute("data-wysihtml5-selection-offset") ? (b = a.getAttribute("data-wysihtml5-selection-offset"), c = a.getAttribute("data-wysihtml5-selection-node"), a = this.element) : (a = this.element.querySelector("[data-wysihtml5-selection-offset]") || this.element, b = a.getAttribute("data-wysihtml5-selection-offset"), c = a.getAttribute("data-wysihtml5-selection-node"),
                a.removeAttribute("data-wysihtml5-selection-offset"), a.removeAttribute("data-wysihtml5-selection-node"));
            null !== c && (a = this.getChildNodeByIndex(a, +c));
            this.composer.selection.set(a, b)
        },
        getChildNodeIndex: function(a, b) {
            for (var c = 0, d = a.childNodes, g = d.length; c < g; c++)
                if (d[c] === b) return c
        },
...
(function(b) {
    ...
    b.views.Composer = b.views.View.extend({
        ...
        isEmpty: function() {
            var a =
                this.element.innerHTML.toLowerCase();
        ...
        _initSandbox: function() {
            ...
            var b = this.textarea.element;
            c.insert(this.iframe).after(b);
            if (b.form) {
        ...
        _create: function() {
            ...
            e && (c.addClass(this.element, e),
                c.addClass(this.iframe, e));
            this.enable();
            ...
            (this.textarea.element.hasAttribute("autofocus") || document.querySelector(":focus") == this.textarea.element) && !a.isIos() &&
                setTimeout(function() {
                    d.focus(!0)
                }, 100);
        ...
        _initAutoLinking: function() {
            ...
            if (this.config.autoLink) {
                if (!f || f && e) this.parent.on("newword:composer", function() {
                    c.getTextContent(d.element).match(c.autoLink.URL_REG_EXP) &&
                ...
                var h = this.sandbox.getDocument().getElementsByTagName("a"),
        ...
        _initObjectResizing: function() {
            ...
            if (a.supportsEvent("resizeend")) {
                var d = ["width", "height"],
                    e = d.length,
                    f = this.element;
                c.observe(f, "resizeend", function(a) {
                    var a = a.target || a.srcElement,
                        c = a.style,
                        g = 0,
                        j;
                    if ("IMG" === a.nodeName) {
                        for (; g < e; g++) j = d[g], c[j] && (a.setAttribute(j, parseInt(c[j], 10)), c[j] = "");
                        b.quirks.redraw(f)
                    }
                })
            }
        ...
        _initLineBreaking: function() {
            function d(a) {
                var b =
                    c.getParentElement(a, {
                        nodeName: ["P", "DIV"]
                    }, 2);
                b && e.selection.executeAndRestore(function() {
                    e.config.useLineBreaks ? c.replaceWithChildNodes(b) : "P" !== b.nodeName && c.renameElement(b, "p")
                })
            }
            var e = this,
                f = "LI P H1 H2 H3 H4 H5 H6".split(" "),
                h = ["UL", "OL", "MENU"];
            this.config.useLineBreaks || c.observe(this.element, ["focus", "keydown"], function() {
                if (e.isEmpty()) {
                    var b = e.doc.createElement("P");
                    e.element.innerHTML = "";
                    e.element.appendChild(b);
                    a.displaysCaretInEmptyContentEditableCorrectly() ? e.selection.selectNode(b, !0) : (b.innerHTML = "<br>", e.selection.setBefore(b.firstChild))
                }
            });
            c.observe(this.doc, "keydown", function(a) {
                var g = a.keyCode;
                if (!a.shiftKey && !(g !== b.ENTER_KEY && g !== b.BACKSPACE_KEY)) {
                    var j = c.getParentElement(e.selection.getSelectedNode(), {
                        nodeName: f
                    }, 4);
                    j ? setTimeout(function() {
                            ...
                            if ("LI" === j.nodeName) {
                                if (!a) return;
                                (f = c.getParentElement(a, {
                                    nodeName: h
                                }, 2)) || d(a)
                            }
                            g === b.ENTER_KEY && j.nodeName.match(/^H[1-6]$/) && d(a)
                        }, 0) : e.config.useLineBreaks && (g === b.ENTER_KEY && !b.browser.insertsLineBreaksOnReturn()) &&
                        (e.commands.exec("insertLineBreak"), a.preventDefault())
                }
            })
        }
    })
...
(function(b) {
    var c = b.dom,
        ...
        h = "background-color border-collapse border-bottom-color border-bottom-style border-bottom-width border-left-color border-left-style border-left-width border-right-color border-right-style border-right-width border-top-color border-top-style border-top-width clear display float margin-bottom margin-left margin-right margin-top outline-color outline-offset outline-width outline-style padding-left padding-right padding-top padding-bottom position top left right bottom z-index vertical-align text-align -webkit-box-sizing -moz-box-sizing -ms-box-sizing box-sizing -webkit-box-shadow -moz-box-shadow -ms-box-shadow box-shadow -webkit-border-top-right-radius -moz-border-radius-topright border-top-right-radius -webkit-border-bottom-right-radius -moz-border-radius-bottomright border-bottom-right-radius -webkit-border-bottom-left-radius -moz-border-radius-bottomleft border-bottom-left-radius -webkit-border-top-left-radius -moz-border-radius-topleft border-top-left-radius width height".split(" "),
        i = ["html                 { height: 100%; }", "body                 { height: 100%; padding: 1px 0 0 0; margin: -1px 0 0 0; }", "body > p:first-child { margin-top: 0; }", "._wysihtml5-temp     { display: none; }", b.browser.isGecko ? "body.placeholder { color: graytext !important; }" : "body.placeholder { color: #a9a9a9 !important; }", "img:-moz-broken      { -moz-force-broken-image-icon: 1; height: 24px; width: 24px; }"];
    b.views.Composer.prototype.style = function() {
        var g = this,
            j = a.querySelector(":focus"),
            k = this.textarea.element,
            m = k.hasAttribute("placeholder"),
            n = m && k.getAttribute("placeholder"),
            v = k.style.display,
            u = k.disabled,
            p;
        ...
        if (k.getAttribute("rows") && "auto" === c.getStyle("height").from(k) || k.getAttribute("cols") && "auto" === c.getStyle("width").from(k)) k.style.display = p = v;
        ...
        if (k.setActive) try {
            ...
            var t = k.style,
                u = a.documentElement.scrollTop || a.body.scrollTop,
                q = a.documentElement.scrollLeft || a.body.scrollLeft,
                t = {
                    position: t.position,
                    top: t.top,
                    left: t.left,
                    WebkitUserSelect: t.WebkitUserSelect
                };
            c.setStyles({
                position: "absolute",
                top: "-99999px",
...
(function(b) {
    ...
    b.views.Composer.prototype.observe = function() {
        var e = this,
            f = this.getValue(),
            h = this.sandbox.getIframe(),
            i = this.element,
            g = a.supportsEventsInIframeCorrectly() ? i : this.sandbox.getWindow();
        ...
        a.hasHistoryIssue() && a.supportsSelectionModify() && c.observe(i, "keydown", function(a) {
            if (a.metaKey || a.ctrlKey) {
                var b = a.keyCode,
                    c = i.ownerDocument.defaultView.getSelection();
                if (37 === b || 39 === b) 37 === b && (c.modify("extend",
                    "left", "lineboundary"), a.shiftKey || c.collapseToStart()), 39 === b && (c.modify("extend", "right", "lineboundary"), a.shiftKey || c.collapseToEnd()), a.preventDefault()
            }
        });
        ...
        c.observe(i, "keydown", function(a) {
            var c = e.selection.getSelectedNode(!0),
                d = a.keyCode;
            if (c && "IMG" === c.nodeName && (d === b.BACKSPACE_KEY || d === b.DELETE_KEY)) d = c.parentNode, d.removeChild(c), "A" === d.nodeName && !d.firstChild &&
                d.parentNode.removeChild(d), setTimeout(function() {
                    b.quirks.redraw(i)
                }, 0), a.preventDefault()
        });
        ...
        c.observe(i, "mouseover", function(a) {
            var a = a.target,
                b = a.nodeName;
            !("A" !== b && "IMG" !== b) && !a.hasAttribute("title") &&
                (b = k[b] + (a.getAttribute("href") || a.getAttribute("src")), a.setAttribute("title", b))
        })
    }
})(wysihtml5);
(function(b) {
    b.views.Synchronizer = Base.extend({
        ...
        _observe: function() {
            ...
            this.editor.on("change_view", function(b) {
                "composer" === b && !c ? (a.fromTextareaToComposer(!0), e()) : "textarea" === b && (a.fromComposerToTextarea(!0), f())
            });
    ...
    b.toolbar.Toolbar = Base.extend({
        ...
        _getLinks: function(a) {
            for (var c = this[a + "Links"] = b.lang.array(this.container.querySelectorAll("[data-wysihtml5-" +
                    a + "]")).get(), e = c.length, f = 0, h = this[a + "Mapping"] = {}, i, g, j, k, m; f < e; f++) i = c[f], j = i.getAttribute("data-wysihtml5-" + a), k = i.getAttribute("data-wysihtml5-" + a + "-value"), g = this.container.querySelector("[data-wysihtml5-" + a + "-group='" + j + "']"), m = this._getDialog(i, j), h[j + ":" + k] = {
                link: i,
                group: g,
                name: j,
                value: k,
        ...
        execCommand: function(a, b) {
            if (!this.commandsDisabled) {
                ...
                c && c.dialog && !c.state ? c.dialog.show() : this._execCommand(a,
                    b)
            }
        },
        ...
        execAction: function(a) {
            var b = this.editor;
            "change_view" === a && (b.currentView === b.textarea ? b.fire("change_view", "composer") : b.fire("change_view", "textarea"))
        },
        _observe: function() {
            for (var a = this, b = this.editor, e = this.container, f = this.commandLinks.concat(this.actionLinks), h = f.length, i = 0; i < h; i++) c.setAttributes({
                href: "javascript:;",
                unselectable: "on"
            }).on(f[i]);
            c.delegate(e, "[data-wysihtml5-command], [data-wysihtml5-action]",
                "mousedown",
                function(a) {
                    a.preventDefault()
                });
            ...
            b.on("blur:composer", function() {
                clearInterval(a.interval)
            });
            b.on("destroy:composer", function() {
                clearInterval(a.interval)
            });
            b.on("change_view", function(b) {
                setTimeout(function() {
        ...
        _updateLinkStates: function() {
            var a = this.commandMapping,
                ...
                e, f, h;
            for (e in a) h = a[e], this.commandsDisabled ? (f = !1, c.removeClass(h.link,
                ...
                h.dialog.hide())) : (c.removeClass(h.link, "wysihtml5-command-active"), h.group && c.removeClass(h.group, "wysihtml5-command-active"), h.dialog && h.dialog.hide()));
    ...
    b.Editor = b.lang.Dispatcher.extend({
        constructor: function(a, d) {
            ...
            this.currentView = this.textarea =
                new b.views.Textarea(this, this.textareaElement, this.config);
            ...
            if (!this._isCompatible || !this.config.supportTouchDevices && b.browser.isTouchDevice()) {
                ...
                this.on("beforeload", function() {
                    this.synchronizer =
                        new b.views.Synchronizer(this, this.textarea, this.composer);
