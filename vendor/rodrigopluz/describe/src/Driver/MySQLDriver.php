...
use Rodrigopluz\Describe\Column;
use Rodrigopluz\Describe\Exceptions\TableNotFoundException;
use Rodrigopluz\Describe\Table;
...
class MySQLDriver implements DriverInterface
{
     ...
     *
     * @return \Rodrigopluz\Describe\Table[]
     */
     ...
     *
     * @param  \Rodrigopluz\Describe\Column $column
     * @param  string                  $table
     * @param  mixed                   $row
     * @return \Rodrigopluz\Describe\Column
     */
     ...
     * @param  array   $tables
     * @return array|\Rodrigopluz\Describe\Table[]
     */
