...
## [0.9.5](https://github.com/rodrigopluz/slytherin/compare/v0.9.4...v0.9.5) - 2017-02-23
...
## [0.9.4](https://github.com/rodrigopluz/slytherin/compare/v0.9.3...v0.9.4) - 2017-02-07

### Fixed
- Empty `attributes` when using `ServerRequest::getAttribute`

## [0.9.3](https://github.com/rodrigopluz/slytherin/compare/v0.9.2...v0.9.3) - 2018-02-05
...
## [0.9.2](https://github.com/rodrigopluz/slytherin/compare/v0.9.1...v0.9.2) - 2017-10-27

### Fixed
- Getting default values of a class in `Container\ReflectionContainer`
- Returning empty values in `Integration\Configuration`

## [0.9.1](https://github.com/rodrigopluz/slytherin/compare/v0.9.0...v0.9.1) - 2017-07-21

### Fixed
- Retrieving a single uploaded file in `ServerRequest::getUploadedFiles`

## [0.9.0](https://github.com/rodrigopluz/slytherin/compare/v0.8.0...v0.9.0) - 2017-07-08
...
- `Rodrigopluz\Router::prefix` for adding prefix in succeeding route endpoints
- `Rodrigopluz\Router::restful` for adding RESTful routes based on one base route
- `Rodrigopluz\DispatcherInterface::router` for setting up routers manually
...
- `Dispatching` directory to `Rodrigopluz`
...
### Removed
- HTTP method spoofing (apply it on a [middleware](https://github.com/rodrigopluz/weasley/blob/master/src/Http/Middleware/FormMethodSpoofing.php) instead)
...
## [0.8.0](https://github.com/rodrigopluz/slytherin/compare/v0.7.0...v0.8.0) - 2016-09-08
...
## [0.7.0](https://github.com/rodrigopluz/slytherin/compare/v0.6.0...v0.7.0) - 2016-07-17
...
## [0.6.0](https://github.com/rodrigopluz/slytherin/compare/v0.5.0...v0.6.0) - 2016-05-24
...
## [0.5.0](https://github.com/rodrigopluz/slytherin/compare/v0.4.3...v0.5.0) - 2016-04-14
...
## [0.4.3](https://github.com/rodrigopluz/slytherin/compare/v0.4.2...v0.4.3) - 2016-02-19

### Added
- Setting of headers in `Response` (if any)

## [0.4.2](https://github.com/rodrigopluz/slytherin/compare/v0.4.1...v0.4.2) - 2016-02-07

### Added
- [Dispatching\BaseRouter](https://github.com/rodrigopluz/slytherin/blob/v0.4.2/src/Dispatching/BaseRouter.php)

### Fixed
- Issue on parsing a route of the same URI but different HTTP method

## [0.4.1](https://github.com/rodrigopluz/slytherin/compare/v0.4.0...v0.4.1) - 2016-02-01
...
## [0.4.0](https://github.com/rodrigopluz/slytherin/compare/v0.3.0...v0.4.0) - 2016-01-13
...
## [0.3.0](https://github.com/rodrigopluz/slytherin/compare/v0.2.1...v0.3.0) - 2015-11-02
...
## [0.2.1](https://github.com/rodrigopluz/slytherin/compare/v0.2.0...v0.2.1) - 2015-09-30

### Added
- [`Uri`](https://github.com/rodrigopluz/slytherin/blob/v0.2.1/src/Uri.php) library in the [`View`](https://github.com/rodrigopluz/slytherin/blob/v0.2.1/src/View.php) class
...
### Removed
- `checkDirectories` method in [`Application`](https://github.com/rodrigopluz/slytherin/blob/v0.2.1/src/Application.php) class

## [0.2.0](https://github.com/rodrigopluz/slytherin/compare/v0.1.0...v0.2.0) - 2015-07-21
