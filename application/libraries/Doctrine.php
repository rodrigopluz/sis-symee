...
use Rodrigopluz\Describe\Driver\CodeIgniterDriver;
use Rodrigopluz\Describe\Describe;
 ...
 * @package  CodeIgniter
 * @category Library
 * @author   Rodrigopluz Gutib    <rodrigopluz@gmail.com>
 * 
...
class Doctrine
{
    ...
    public function __construct()
    {
         ...
         */
        $this->_query_builder = $this->em->createQueryBuilder();
     ...
     * @return Doctrine
     */
    public function get_all($table, $delimiters = [])
    {
     ...
     */
    private function _find_by_keyword($keyword, $table = NULL, $tables = [], $table_alias = NULL)
    {
        if ($table == NULL) {
            $table = $this->_table;
        }
