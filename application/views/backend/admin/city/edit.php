...
<div class="row">
	<div class="clearfix">
		<?= form_open('Citys/edit/'. $city['id'], ['class' => 'form-content']); ?>
			<div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-6">
				...
				<div class="">
					...
					<?= form_dropdown('initial', $country_option, set_value('initial', $city['initial']), ['class' => 'form-control', 'id' => 'pais-id']); ?>
					<?= form_error('initial'); ?>
				</div>
			</div>
			<div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-6">
				...
				<div class="">
					...
					<?= form_dropdown('sigla', $states_option, set_value('sigla', $city['sigla']), ['class' => 'form-control', 'id' => 'sigla']); ?>
					<?= form_error('sigla'); ?>
				</div>
			</div>
			<div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-6">
				...
				<div class="">
					<?= form_input(['name' => 'name', 'id' => 'city', 'class' => 'form-control', 'value' => set_value('nome', $city['name'])]); ?>
					<?= form_error('nome'); ?>
				</div>
			</div>
			<div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-6">
				...
				<div class="">
					<?= form_input(['name' => 'cod_municipio_ibge', 'id' => 'cod-municipio-ibge', 'class' => 'form-control', 'value' => set_value('cod_municipio_ibge', $city['cod_municipio_ibge'])]); ?>
