...
<div class="row">
	<div class="clearfix">
		<?= form_open('FunctionCategorys/edit/'. $function_category['id'], ['class' => 'form-content']); ?>
			<div class="form-group  col-lg-6 col-md-6 col-sm-6 col-xs-6">
				<?= form_label(get_phrase('category'), 'category', ['class' => 'control-label']); ?>
				<div class="">
					<?= form_input(['name' => 'category', 'id' => 'category', 'class' => 'form-control', 'value' => set_value('category', $function_category['category'])]); ?>
					<?= form_error('category'); ?>
				</div>
			</div>
