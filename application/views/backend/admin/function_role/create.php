...
<div class="row">
	<div class="clearfix">
		<?= form_open('FunctionRoles/create/', ['class' => 'form-content']); ?>
			<div class="form-group  col-lg-4 col-md-4 col-sm-4 col-xs-4">
				<?= form_label(get_phrase('function_role'), 'name', ['class' => 'control-label']); ?>
				<div class="">
					<?= form_input(['name' => 'name', 'id' => 'name', 'class' => 'form-control', 'value' => '']); ?>
					<?= form_error('name'); ?>
				</div>
			</div>
			<div class="form-group  col-lg-4 col-md-4 col-sm-4 col-xs-4">
				...
				<div class="">
					...
					<?= form_dropdown('category', $category_option, set_value('id'), ['class' => 'form-control', 'id' => 'category']); ?>
					<?= form_error('category'); ?>
				</div>
			</div>
			<div class="form-group  col-lg-4 col-md-4 col-sm-4 col-xs-4">
