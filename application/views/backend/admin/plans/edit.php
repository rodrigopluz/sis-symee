...
<div class="row">
	<div class="clearfix">
		<?= form_open('Plans/edit/'. $plan['id'], ['class' => 'form-content']); ?>
			<div class="form-group col-lg-4 col-md-4 col-sm-4 col-xs-4">
				...
				<div class="">
					...
					<?= form_dropdown('type', $type_option, set_value('type', $plan['type']), ['id' => 'type', 'class' => 'form-control']); ?>
				</div>
			</div>
			<div class="form-group col-lg-3 col-md-3 col-sm-3 col-xs-3">
				...
				<div class="input-spinner">
					...
					<?= form_input(['name' => 'quantity', 'id' => 'quantity', 'class' => 'form-control', 'value' => $plan['quantity']]); ?>
					<button type="button" class="btn btn-default">+</button>
				</div>
			</div>
			<div class="form-group col-lg-2 col-md-2 col-sm-2 col-xs-2">
				...
				<div class="">
					<div class="input-group">
						...
						<?= form_input(['name' => 'price', 'id' => 'price', 'class' => 'form-control mask-money', 'value' => $plan['price'], 'data-mask' => 'currency', 'data-sign' => get_phrase('simbol_money')]); ?>
					</div>
				</div>
			</div>
			<div class="form-group col-lg-3 col-md-3 col-sm-3 col-xs-3">
