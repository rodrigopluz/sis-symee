...
$config['uri_protocol']	= 'REQUEST_URI'; // php 7.0
// $config['uri_protocol']	= 'AUTO';    // php 7.2
 ...
 */
$config['encryption_key'] = 'sis-symee2019';
...
$config['csrf_token_name'] = 'sis_symee';
$config['csrf_cookie_name'] = 'sis_symee';
